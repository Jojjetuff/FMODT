	...
	while true do
		...
		elseif SelectedLanguage == 4 then
			...
			-- Player Menu
				...
				SexActsTitle = "Sekso veiksmai" -- "Sekso veiksmai"
				StopSexActsTitle = "Baigti"
				AnalFuckedTitle = "Analinio gavėjas" -- "Analinio gavėjas"
				AnalFuckerTitle = "Analinio davėjas" -- "Analinio davėjas"
				CarBJGetterTitle = "Oralinio gavėjas mašinoje" -- "Oralinio gavėjas mašinoje"
				CarBJGiverTitle = "Oralinio davėjas mašinoje" -- "Oralinio davėjas mašinoje"
				CarSexGetterTitle = "Seksas mašinoje gavėjas" -- "Seksas mašinoje gavėjas"
				CarSexGiverTitle = "Seksas mašinoje davėjas" -- "Seksas mašinoje davėjas"
				StripsTitle = "Striptizas" -- "Striptizas"
				StopStripTitle = "Baigti"
				PoleDance1Title = "1. Stulpo šokis" -- "1. Stulpo šokis"
				PoleDance2Title = "2. Stulpo šokis" -- "2. Stulpo šokis"
				PoleDance3Title = "3. Stulpo šokis" -- "3. Stulpo šokis"
				LapDanceTitle = "Lap Dance" -- Not translated "Lap Dance"
				PrivateDanceTitle = "Privatus šokis" -- "Privatus šokis"
