		...
		if player then
			...
			if NetworkIsPlayerConnected(player) then
				if adminInformations then
					...
					if playerPing == nil then playerPing = "~r~N/A" end
					if LicenseID[1] == nil then LicenseID[1] = "~r~N/A" end
					if LicenseID[2] == nil then LicenseID[2] = "" end
					if SteamID == nil then SteamID = "~r~N/A" end
					_DrawRect(0.5, 0.8675, 0.230, 0.26, GUI.optionRect[1], GUI.optionRect[2], GUI.optionRect[3], GUI.optionRect[4], 6)
					Draw(NameTitle .. ": ~y~" .. PlayerName, 255, 255, 255, 255, 0.400, 0.7550, 0.5, 0.5, 7, false, 1)
					Draw(MenuNameTitle .. ": ~y~" .. PlayerUsername, 255, 255, 255, 255, 0.400, 0.7875, 0.5, 0.5, 7, false, 1)
					Draw(IPTitle .. ": ~y~" .. playerIP, 255, 255, 255, 255, 0.400, 0.8200, 0.5, 0.5, 7, false, 1)
					Draw(PingTitle .. ": ~y~" .. playerPing, 255, 255, 255, 255, 0.400, 0.8525, 0.5, 0.5, 7, false, 1)
					Draw(SteamIDTitle .. ": ~y~" .. SteamID, 255, 255, 255, 255, 0.400, 0.8850, 0.5, 0.5, 7, false, 1)
					Draw(LicenseIDTitle .. ": ~y~" .. LicenseID[1] .. " - ", 255, 255, 255, 255, 0.400, 0.9175, 0.5, 0.5, 7, false, 1)
					Draw("~y~" .. LicenseID[2], 255, 255, 255, 255, 0.455, 0.9500, 0.5, 0.5, 7, false, 1)
				end
